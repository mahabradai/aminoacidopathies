...
class MedecinResourceIT {
    ...
    void createMedecin() throws Exception {
        ...
        assertThat(testMedecin.getCin()).isEqualTo(DEFAULT_CIN);
    ...
    void putExistingMedecin() throws Exception {
        ...
        assertThat(testMedecin.getCin()).isEqualTo(UPDATED_CIN);
    ...
    void partialUpdateMedecinWithPatch() throws Exception {
        ...
        partialUpdatedMedecin.prenom(UPDATED_PRENOM).cin(UPDATED_CIN).tel(UPDATED_TEL);
