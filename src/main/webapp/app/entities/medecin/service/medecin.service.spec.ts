...
import { sampleWithRequiredData, sampleWithNewData, sampleWithPartialData, sampleWithFullData } from '../medecin.test-samples';
...
describe('Medecin Service', () => {
  ...
  describe('Service methods', () => {
    ...
    it('should create a Medecin', () => {
      ...
      service.create(medecin).subscribe(resp => (expectedResult = resp.body));
    ...
    it('should update a Medecin', () => {
      ...
      service.update(medecin).subscribe(resp => (expectedResult = resp.body));
