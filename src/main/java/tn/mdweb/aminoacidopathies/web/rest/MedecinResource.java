...
import tn.mdweb.aminoacidopathies.service.MedecinService;
...
/**
 * REST controller for managing {@link tn.mdweb.aminoacidopathies.domain.Medecin}.
 */
@RestController
@RequestMapping("/api")
public class MedecinResource {
     ...
     */
    @GetMapping("/medecins")
    public ResponseEntity<List<MedecinDTO>> getAllMedecins(@org.springdoc.api.annotations.ParameterObject Pageable pageable) {
