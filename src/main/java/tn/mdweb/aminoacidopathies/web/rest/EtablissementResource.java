...
import tn.mdweb.aminoacidopathies.service.EtablissementService;
...
/**
 * REST controller for managing {@link tn.mdweb.aminoacidopathies.domain.Etablissement}.
 */
@RestController
@RequestMapping("/api")
public class EtablissementResource {
    ...
    public ResponseEntity<EtablissementDTO> updateEtablissement(
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, etablissementDTO.getId().toString()))
            .body(result);
    }
    ...
    public ResponseEntity<EtablissementDTO> partialUpdateEtablissement(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, etablissementDTO.getId().toString())
        );
    }
    ...
    public ResponseEntity<List<EtablissementDTO>> getAllEtablissements(@org.springdoc.api.annotations.ParameterObject Pageable pageable) {
